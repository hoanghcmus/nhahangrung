    ...
    protected string ShowArticleCat(object sender, string column)
    {
        ...
        switch (column)
        {
            ...
            case "ArticleCatDuongDan":
                ...
                {
                    return "/vn/s-article/" + Helper.RejectMarks(Eval("TieuDe_En").ToString()) + "-" + baiviet.ID + "-" + baiviet.IDTheLoai + ".html";
                }
                else if (Session["lang"].ToString().Equals("en"))
                {
                    return "/en/s-article/" + Helper.RejectMarks(Eval("TieuDe_En").ToString()) + "-" + baiviet.ID + "-" + baiviet.IDTheLoai + ".html";
                }
                else if (Session["lang"].ToString().Equals("ru"))
                {
                    return "/ru/s-article/" + Helper.RejectMarks(Eval("TieuDe_En").ToString()) + "-" + baiviet.ID + "-" + baiviet.IDTheLoai + ".html";
                }
