<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MgerXuLyDatSpa.aspx.cs" Inherits="Admin_MgerXuLyDatTour1" %>
        ...
        <div class="container">
            <div id="feedback">
                ...
                <table class="GuiYkien">
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="title" runat="server" Text="Thông tin khách hàng đặt phòng Spa" CssClass="title" />
