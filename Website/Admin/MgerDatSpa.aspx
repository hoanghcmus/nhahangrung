<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="MgerDatSpa.aspx.cs" Inherits="Admin_MgerDatTiec" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Quản lý phòng Spa<span class="divider">>></span></li>
            <li class="active">Đặt phòng Spa trực tuyến<span class="divider">>></span></li>
        </ul>
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="content_right">
                    <div class="toolbar">
                        Hiển thị tất cả các đặt phòng Spa giới hạn theo ngày:<asp:Label ID="lblStatus" runat="server"
                            CssClass="red" /><br />
                        ...
                        <asp:DropDownList runat="server" ID="ddlCategory" AutoPostBack="true" AppendDataBoundItems="true"
                            ...
                            <asp:ListItem>Chọn xem quản lý đặt phòng Spa</asp:ListItem>
                            <asp:ListItem Value="0">Đặt phòng Spa đợi duyệt</asp:ListItem>
                            <asp:ListItem Value="1">Đặt phòng Spa đã duyệt</asp:ListItem>
                            <asp:ListItem Value="2">Đặt phòng Spa đã hủy</asp:ListItem>
                        </asp:DropDownList>
                        <asp:Button Text="Xóa đặt phòng Spa đã chọn" runat="server" ID="btnDelete" CssClass="multidelete" />
                        <input type="button" value="Làm mới" class="btnedit" onclick="location.href = 'MgerDatSpa.aspx'" />
                    </div>
                    <div class="block">
                        <p class="block-heading">
                            Danh sách đặt phòng Spa khách hàng
                        </p>
                        <div class="helpDatHang">
                            Chú ý: <span class="red">Chữ đỏ: Đặt phòng Spa chưa duyệt </span><span>Chữ thường: Đặt phòng Spa
                                đã duyệt</span><span class="textoverline">Chữ gạch: Đặt phòng Spa đã hủy</span>
                        </div>
                        <table class="list">
                            <thead>
                                <tr>
                                ...
                                <AlternatingItemTemplate>
                                    <tr class="eventop">
                                        ...
                                        <td class="smallmax" style="text-align: center;">
                                            <a href="javascript:void(0)" target="_blank" class="btnlinkaddlist" onclick='window.open("MgerXuLyDatSpa.aspx?id=<%#Eval("ID") %>","Upload","height=480,width=640,");return false;'>
